...
import 'package:pkm_nutritrack/view/UserClassification2.dart'; // Import the next screen

class UserClassificationScreen extends StatefulWidget {
  const UserClassificationScreen({Key? key}) : super(key: key);

  @override
  _UserClassificationScreenState createState() => _UserClassificationScreenState();
}
...
class _UserClassificationScreenState extends State<UserClassificationScreen> {
  ...
  Widget _buildGridButton(BuildContext context, String imagePath, String text, int index) {
